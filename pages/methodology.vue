  ...
  <div class="page-shell article-shell">
    ...
    <section v-if="scoring" class="scoring-sheet">
      ...
      <dl>
        ...
        <div>
          <dt>发行窗口</dt>
          <dd>当前游戏版本发行后 180 天可正常参评，包括正式版与独立发行版本；新作 ×1.25 加分仅限首次可玩发行后的 30 天内。重大更新／DLC 证据窗口 14 天。</dd>
        </div>
        <div>
          <dt>人数权重</dt>
        ...
        <div>
          <dt>老游戏回归</dt>
          <dd>正常参评窗口结束后，仅限当前版本发行两年内，须有官方重大更新／DLC，且峰值严格超过此前历史纪录 30%；不设绝对人数下限，缺少历史证据暂不入选。当前版本满三年排除采集与选星；原作及早期 EA 日期不覆盖当前版本发行日。</dd>
        </div>
        <div>
          <dt>出现天数</dt>
